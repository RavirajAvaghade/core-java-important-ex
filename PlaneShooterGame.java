...
class Enemy {
    int x, y;
    final int width = 40, height = 40, speed = 3;
...
public class PlaneShooterGame extends JPanel implements ActionListener, KeyListener {
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Plane Shooter Game");
        PlaneShooterGame game = new PlaneShooterGame();
        frame.add(game);
        frame.pack();
